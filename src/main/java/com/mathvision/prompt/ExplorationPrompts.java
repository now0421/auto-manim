...
public final class ExplorationPrompts {
    ...
    private static final String CONCEPT_GRAPH_SYSTEM =
            "Plan a compact teaching DAG for a middle-school math concept.\n"
                    ...
                    + "5. If comparing with other results at the end can better help the learner understand the conclusion, add a corresponding comparison beat.\n\n"
                    + "Edge rules:\n"
    ...
    private static final String PROBLEM_GRAPH_SYSTEM =
            "Plan presentation-ready teaching beats for a middle-school math problem.\n"
                    ...
                    + "The graph should help the learner move from hook to observation to key insight to conclusion, rather than a dry list of purely solving steps.\n"
                    ...
                    + "If comparing with other results at the end can better help the learner understand the conclusion, add a corresponding comparison beat.\n"
