...
public final class ToolSchemas {
    ...
    public static final String STORYBOARD = "["
            ...
            + "              \"notes_for_codegen\": {"
            + "                \"type\": \"array\","
            + "                \"description\": \"Hard scene-level implementation constraints for code generation and repair, especially around continuity, transforms, motion ranges, endpoints, visibility, lifecycle, style, or layout edge cases\","
            + "                \"items\": { \"type\": \"string\" }"
            + "              }"
            + "            },"
            + "            \"additionalProperties\": false,"
    ...
    public static final String SCENE_DESIGN = "["
            ...
            + "              }"
            + "            },"
            + "            \"notes_for_codegen\": { \"type\": \"array\", \"description\": \"Hard scene-level implementation constraints that downstream code generation and repair must preserve\", \"items\": { \"type\": \"string\" } }"
            + "          },"
            + "          \"required\": [\"scene_id\", \"title\", \"goal\", \"narration\", \"layout_goal\", \"safe_area_plan\", \"entering_objects\", \"persistent_objects\", \"exiting_objects\", \"actions\"]"
            + "        },"
            + "        \"new_objects\": {"
    ...
    public static final String CODE_REVIEW = "["
            ...
            + "    \"description\": \"Return structured rule-compliance checks for Manim or GeoGebra output before render.\","
            + "    \"parameters\": {"
            + "      \"type\": \"object\","
            + "      \"properties\": {"
            + "        \"approved_for_render\": { \"type\": \"boolean\", \"description\": \"True only when every mandatory rule is pass or not_applicable and there are no blocking issues\" },"
            + "        \"rule_checks\": {"
            + "          \"type\": \"array\","
            + "          \"description\": \"One explicit compliance check per review rule.\","
            + "          \"items\": {"
            + "            \"type\": \"object\","
            + "            \"properties\": {"
            + "              \"rule_id\": { \"type\": \"string\" },"
            ...
            + "            },"
            + "            \"required\": [\"rule_id\", \"requirement\", \"status\", \"evidence\"]"
            + "          }"
            + "        },"
            + "        \"summary\": { \"type\": \"string\" },"
