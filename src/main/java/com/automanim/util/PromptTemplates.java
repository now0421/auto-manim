...
public final class PromptTemplates {
    ...
    public static final String FOUNDATION_CHECK_SYSTEM =
            ...
            + "\n"
            + "This result will later be used as a node in a prerequisite knowledge tree, so the"
            ...
            + "5. If the concept would create obvious overlap with sibling or parent concepts in a"
            + " prerequisite tree, answer no.\n"
    ...
    public static final String PREREQUISITES_SYSTEM =
            ...
            + "\n"
            + "These prerequisites will be used to build a knowledge tree for generating a teaching"
