...
public final class PromptTemplates {
    ...
    public static final String PREREQUISITES_SYSTEM =
            ...
            + "- \"description\": one or two sentences describing what this prerequisite contributes"
            + " to the learning path and what understanding it should establish\n"
            + "\n"
            + "Example:\n"
            + "[{\"concept\": \"Unit circle\", \"description\": \"Establish the geometric object"
            + " on which sine and cosine are defined, so later coordinate relationships have a"
            + " concrete reference.\"}]";
    ...
    public static final String PROBLEM_STEP_GRAPH_SYSTEM =
            ...
            + "      \"description\": \"what the final step concludes\",\n"
            ...
            + "    {\n"
            + "      \"id\": \"previous_step\",\n"
            + "      \"concept\": \"key previous step\",\n"
            + "      \"description\": \"what this step establishes before the conclusion\",\n"
